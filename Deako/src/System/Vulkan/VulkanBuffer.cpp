...
namespace Deako {
    ...
    void Buffer::CopyStaging(VkBuffer stagingBuffer, VkBuffer receivingBuffer, VkDeviceSize size)
    {
        ...
        allocInfo.commandPool = VulkanCommandPool::GetPool();
    ...
    void VulkanBufferPool::CreateDescriptorPool()
    {
        ...
        poolSize.descriptorCount = static_cast<uint32_t>(VulkanBase::MAX_FRAMES_IN_FLIGHT);

        VkDescriptorPoolCreateInfo poolInfo{};
        poolInfo.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
        poolInfo.poolSizeCount = 1;
        poolInfo.pPoolSizes = &poolSize;
        poolInfo.maxSets = static_cast<uint32_t>(VulkanBase::MAX_FRAMES_IN_FLIGHT);
