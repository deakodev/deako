...
namespace Deako {
    ...
    {
    public:
        virtual void AddAsset(Ref<Asset> asset, const AssetMetadata& metadata) = 0;
        ...
        virtual Ref<Asset> ImportAsset(const AssetType& type, const std::filesystem::path& path) = 0;
    ...
    public:
        ...
        virtual void AddAsset(Ref<Asset> asset, const AssetMetadata& metadata) override;
        ...
        virtual Ref<Asset> ImportAsset(const AssetType& type, const std::filesystem::path& path) override;
